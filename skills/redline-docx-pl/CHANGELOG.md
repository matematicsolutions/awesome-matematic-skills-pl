...
- Integracja z silnikiem anonimizacji PII (np. [matematic-anonimizacja-pl](https://github.com/matematicsolutions/matematic-anonimizacja-pl)): tresc (PII) vs metadane (sanitize) jako dwie warstwy.
