...
description: |
  ...
  artefakty czatbota, kalki anglicyzmow.
license: MIT
...
Polska adaptacja blader/humanizer (https://github.com/blader/humanizer, MIT). Oryginal bazuje na Wikipedia "Signs of AI writing" (WikiProject AI Cleanup). Ta wersja: polskie listy slow, polska typografia, wzorzec #29 (kalki), integracja z pipeline MateMatic.
